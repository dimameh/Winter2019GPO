namespace WinterTask
{
    ...
    public class Point3D
    {
        ...
        /// <returns>
        ///     Если все координаты первой точки меньше чем координаты второй, возвращается true,
        ...
        /// <param name="point2">Правый элемент сравнения</param>
        /// <returns>
        ///     Если все координаты первой точки больше чем координаты второй, возвращается true,
        ///     в любом другом случае - false
        /// </returns>
        public static bool operator >(Point3D point1, Point3D point2)
        {
        ...
        /// <param name="point2">Правый элемент сравнения</param>
        /// <returns>
        ///     Если все координаты первой точки меньше или равны координатам второй, возвращается true,
        ///     в любом другом случае - false
        /// </returns>
        public static bool operator <=(Point3D point1, Point3D point2)
        {
        ...
        /// <param name="point2">Правый элемент сравнения</param>
        /// <returns>
        ///     Если все координаты первой точки больше или равны координатам второй, возвращается true,
        ///     в любом другом случае - false
        /// </returns>
        public static bool operator >=(Point3D point1, Point3D point2)
        {
        ...
        /// <returns>
        ///     Возвращает false если объект равен null. В случае если объект хранит ту же ссылку, то вернет true.
        ///     В других случаях производится сравнение типов и выполняется метод Equals для
        ///     текущего и передаваемого объектов. Если типы равны и Equals вернет true, то
        ///     метод вернет true, в любом другом случае - false
        /// </returns>
        ...
        /// <param name="point1">Левый элемент сравнения</param>
        /// <param name="point2">Правый элемент сравнения</param>
        /// <returns>Если все координаты обеих точек равны, возвращает true,
        /// в любом другом случае - false</returns>
        public static bool operator ==(Point3D point1, Point3D point2)
        {
        ...
        /// <param name="point1">Левый элемент сравнения</param>
        /// <param name="point2">Правый элемент сравнения</param>
        /// <returns>Если все координаты обеих точек равны, возвращает false,
        /// в любом другом случае - true</returns>
        public static bool operator !=(Point3D point1, Point3D point2)
        {
            return !Equals(point1, point2);
        }
